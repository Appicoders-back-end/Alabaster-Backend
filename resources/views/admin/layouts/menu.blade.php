            ...
            <ul class="metismenu">
                <li class="border-top">
                    <a class="{{ (request()->is('admin/customers*') || request()->is('admin/cleaners*') || request()->is('admin/contractors*')) ? 'active' : '' }}" href="">
                        <span class="ml-3">User</span><i
                            class="ml-3 fas fa-angle-down"></i>
                    </a>
                    <ul class="sub-menu">
                ...
                <li class=" border-top">
                    <a class="{{ (request()->is('admin/subscriptions*')) ? 'active' : '' }}" href="{{route('admin.subscriptions')}}"><span class="ml-3">Subscription</span></a>
                </li>
                ...
                <li class="border-bottom"><a href="work-order.html"><span class="ml-3">Work Order</span></a>
                </li>
                <li class="border-bottom"><a class="{{ (request()->is('admin/categories*')) ? 'active' : '' }}" href="{{route('admin.categories')}}"><span class="ml-3 ">Category</span></a>
                </li>
                <li class="border-bottom"><a class="{{ (request()->is('admin/contact-queries*')) ? 'active' : '' }}" href="{{route('admin.contact-queries')}}"><span class="ml-3 ">Queries</span></a>
                </li>
                <li class="border-bottom"><a class="{{ (request()->is('admin/terms*')) ? 'active' : '' }}" href="{{route('admin.terms')}}"><span class="ml-3 ">Terms & Service </span></a>
                </li>
