                ...
                <div class="tab-pane active" id="">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <button type="button" class="btn btn-danger col-3" data-toggle="modal" data-target="#addModal">Add
                            </button>
                            <!-- Add Modal -->
                                            ...
                                            <div class="modal-body ">
                                                <div class="md-form mr-3 ml-3 mt-2">
                                                    <label data-error="wrong" data-success="right"
                                                           for="defaultForm-pass">Package Name</label>
                                                ...
                                                <div class="md-form mr-3 ml-3 mt-2">
                                                    ...
                                                    <select name="interval_time" class="form-control border-dark"
                                                            id="interval_time">
                                                ...
                                                <div class="md-form mr-3 ml-3 mt-2">
                                                    ...
                                                    <input name="price" min="0" type="number"
                                                           class=" mb-2 border-dark form-control validate" required>
                                                </div>
                            ...
                            <div class="col-sm-12 col-lg-4">
                                <div class="card ">
                                    <div class="card-body text-center">
                                        ...
                                        <div class="display-5 my-4 font-weight-bold">${{$subscription->price}}
                                            <small>{{$subscription->interval_time}}</small>
                                        </div>
                                        ...
                                        <div class="text-center mt-6">
                                            <button type="button" class="btn btn-danger mt-3"
                                                    onClick="return openEditModal({{$subscription}})">
                                                Edit
                                            </button>
                                            <a href="{{route('admin.delete_subscription', $subscription->id)}}"
